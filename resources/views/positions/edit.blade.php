                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('level') is-invalid @enderror"
                                        ...
                                        <option value="1" {{ old('level', $position->level) == '1' ? 'selected' : '' }}>Level 1 (Terendah)</option>
                                        <option value="2" {{ old('level', $position->level) == '2' ? 'selected' : '' }}>Level 2</option>
                                        <option value="3" {{ old('level', $position->level) == '3' ? 'selected' : '' }}>Level 3</option>
                                        <option value="4" {{ old('level', $position->level) == '4' ? 'selected' : '' }}>Level 4</option>
                                        <option value="5" {{ old('level', $position->level) == '5' ? 'selected' : '' }}>Level 5 (Tertinggi)</option>
                                    </select>
                                    @error('level')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-12">
                                <div class="alert alert-info">
                                    ...
                                    <ul class="mb-0 mt-2">
                                        ...
                                        <li>Perubahan gaji pokok akan mempengaruhi perhitungan gaji guru yang menggunakan jabatan ini</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
