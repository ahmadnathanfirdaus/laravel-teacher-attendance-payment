                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              name="description"
                                              rows="3"
                                              placeholder="Deskripsi jenis tunjangan (opsional)">{{ old('description') }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12">
                                <div class="alert alert-info">
                                    ...
                                    <ul class="mb-0 mt-2">
                                        ...
                                        <li>Jumlah default akan digunakan sebagai nilai awal saat menambahkan tunjangan ke guru</li>
                                        <li>Nilai tunjangan per guru masih dapat disesuaikan setelah jenis tunjangan ini dibuat</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
